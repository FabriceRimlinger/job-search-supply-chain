...
| | |
|---|---|
| **Siège** | Marseille - 33 Bd Ferdinand de Lesseps, 13014 |
| **Fondée** | 1938 |
| **CA** | 481,4 M€ (2024) |
| **Effectifs** | ~215 salariés (holding) - groupe plus large avec filiales |
| **Secteur** | FMCG / Agroalimentaire - fruits & légumes tropicaux (bananes, ananas) |
| **Statut** | Entreprise familiale / groupe privé |

---

## Activités du groupe

- **Production agricole** : plantations en Afrique subsaharienne (bananes, ananas, fruits tropicaux)
- **Logistique intégrée** : transport maritime propre (Africa Express Line), agences maritimes (Éolis)
- **Mûrisseries & distribution** : réseau de mûrisseries en Europe, distribution commerciale
- **Réseau commercial** : France + Europe de l'Est (Roumanie, Hongrie, Pologne) - expansion active

---

## Enjeux actuels identifiés

**Expansion Europe de l'Est** (source : presse 2024)
- Nouvelle base commerciale à Cracovie (Pologne), ouverte juillet 2024
- Volume : ~100 000 T/an en Europe de l'Est
- Déploiement rapide sur marchés émergents = projets de sites, logistique, mûrisseries à structurer
...
Filiale tech de CF fondée en 2017, 11-50 salariés. Plateforme agritech pour la gestion des plantations bananières : traçabilité du régime à la boîte, données géolocalisées, gestion des coûts/main-d'œuvre, module Sigatoka (CIRAD). CEO : Benoît Mauran.

## Contacts & stratégie d'approche

| Contact | Rôle | Contact direct | Statut |
|---------|------|----------------|--------|
...
## Connexion Fabrice ↔ Compagnie Fruitière

- **ColdEnergy France (2012-2014)** : Compagnie Fruitière était client indirect (mûrisseries et plateformes réfrigérées)
- **Pomona (2002-2005)** : 1er mûrissier de bananes en France - même filière, même métier
- **Formation agronome INP Toulouse** : légitimité sectorielle native

→ Fabrice n'est pas un inconnu du secteur - il parle le même langage opérationnel que les équipes CF.

---

## Questions à poser en entretien

- Quels sont les projets industriels les plus critiques pour les 18 prochains mois ?
