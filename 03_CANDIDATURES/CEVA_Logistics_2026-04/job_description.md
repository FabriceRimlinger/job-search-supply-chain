...
- Diriger la fonction de transition des contrats logistiques comme catalyseur stratégique mondial
- Piloter les programmes de démarrages (start-ups), insertions technologiques et transitions de contrats
- Gérer la fonction **Zero Defect Start Up (ZDS)** à l'échelle mondiale
- Superviser les projets globaux : Optymee, Dock Appointment System
- Diriger l'équipe directe de gestionnaires + communauté mondiale ZDS
- Administrer les systèmes logistiques contractuels (WMS, OMS, systèmes d'efficacité)
...
- Maîtrise des outils PM et collaboration : Jira, Confluence, Smartsheet
- Insertion technologique IA et robotique (souhaitable)

## Compétences demandées (mots-clés ATS)

- Contract Logistics, Program Management, Project Management
- Zero Defect Start Up (ZDS), launch management
- WMS, OMS, Systems Implementation, Automation
- Jira, Confluence, Smartsheet
- Prince2, APM
- AI insertion, robotics
