# REALISATIONS - 10 réalisations clés

> Extraites fidèlement des CVs et des performance reviews Amazon Forte (2019-2023).
> Performance reviews Amazon : rating "Exceeds" (2021) - niveau le plus élevé avant promotion.

---

1. **Réduction de 20% du budget Service Client** (économies de 550k€/an) chez Colis Privé, dans un contexte de croissance d'activité de +7,5% - Director Business Excellence, 2024-présent

2. **Réduction de 40% des tâches manuelles** via le déploiement d'un programme d'automatisation (IA forecasting, RPA, call bots) sur l'ensemble des fonctions opérationnelles - Colis Privé, 2024-présent
...
8. **Définition du SOP d'expansion supply chain Amazon sur 36 mois** et lancement de projets pilotes sur la réaffectation de 80+ bâtiments Amazon à travers l'EU - Amazon SC Planning, 2022-2023

9. **Développement du dashboard SNN4** (réduction des blocages de conformité EU, prévention des drop-offs) - reconnu par les pairs pour avoir "guidé l'équipe dans la bonne direction dans de nombreuses instances" - Amazon SC Planning, 2023. *(Source : Forte 2023, peers feedback)*
...
*Extraits fidèles des évaluations 360° Amazon*

- **Leadership principle #1 reconnu** : "Invent & Simplify" - cité dans 100% des reviews (2019, 2020, 2021, 2023)
- **"Tech-Master par excellence"** - compétences Excel/SQL/BI reconnues comme superpower
- **"Multi-cultural and multi-lingual with excellent cross-cultural ability"** - Forte 2020
